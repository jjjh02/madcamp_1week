...
class CustomDropdownButton extends StatefulWidget {
  ...
  CustomDropdownButton(
      {Key? key, required this.contactNames, required this.onSelected})
      : super(key: key);
...
class _ViewCalendarPageWidgetState extends State<ViewCalendarPageWidget> {
  ...
  Future<File> _writeEvents() async {
    ...
    String jsonEvents = jsonEncode(_events.map((key, value) => MapEntry(
  ...
  Future<void> _loadEvents() async {
    try {
      ...
      setState(() {
        ...
        _events = decodedJson.map((key, value) => MapEntry(DateTime.parse(key),
            value.map<Event>((e) => Event.fromJson(e)).toList()));
                    ...
                    decoration: InputDecoration(
                      ...
                      focusedBorder: UnderlineInputBorder(
                        borderSide: BorderSide(
                            color: Colors.black), // 포커스 받았을 때의 색상을 보라색으로 설정
                      ),
                    ),
                  ),
                  TextField(
                      ...
                      child: TextButton(
                        ...
                        style: TextButton.styleFrom(
                          backgroundColor: const Color.fromARGB(
                              255, 255, 255, 255), // 취소 버튼의 배경색을 하얗게 설정
